...
public class BoardBean {
	...
	m_phone1,m_phone2,m_phone3,m_state,m_grade,m_warning,m_regdate,n_num,n_title,n_content,n_ano,n_sdate,
	n_views,r_num,r_content,r_bno,r_sdate,r_mno,r_ip;
	...
	public String getM_warning() {
		return m_warning;
	}

	public void setM_warning(String m_warning) {
